...
export const FOXGO_QUICK_PATTERNS: FoxgoQuickPattern[] = [
  ...
  },
  {
    ...
    answer:
      'Nếu khách quên đồ trên xe, hiện app chưa có mục riêng "Quên đồ" hay nút báo cáo tự động. Hãy báo FoxGo qua driver-support@foxgo.vn hoặc hotline 1900-1234, kèm mã chuyến, mô tả món đồ và thời gian chuyến. FoxGo sẽ hỗ trợ kết nối trong phạm vi có thể.',
  },
  {
