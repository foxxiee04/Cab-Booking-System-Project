...
// This prevents multiple driver accounts in different incognito tabs from overwriting each other's tokens.
...
export const { setCredentials, updateTokens, logout, updateUser, setLoading, setError } = authSlice.actions;
